    ...
    "aria-invalid:ring-destructive/20 aria-invalid:border-destructive hover:cursor-pointer",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-white text-gray-700 shadow-xs",
        outline: "border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground",
        secondary: "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80",
        ghost: "hover:bg-accent border border-gray-400 hover:text-accent-foreground",
        link: "text-center mt-4 text-primary-600 text-xs hover:underline cursor-pointer underline",
      },
      size: {
